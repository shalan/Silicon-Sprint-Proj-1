...
# 2. CLOCK DEFINITIONS
#---------------------------------------------------------------------------#
# clk is the management SoC clock (from Caravel green macro pin).
# xclk is an external GPIO clock (12 MHz) — not a port clock, arrives via gpio_bot_in[2].
# usb_clk (48 MHz FLL/2) is internally generated — not constrained here.
